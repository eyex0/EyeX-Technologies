...
async function seed() {
  ...
  const customers = [
    ...
    },
    {
      ...
      email: "contact@dubai-tech.ae",
      company: "Dubai Tech",
      status: "active",
      lifetime_value: 120000,
    },
    {
      name: "Abu Dhabi Systems",
      email: "info@abudhabi-sys.ae",
      company: "Abu Dhabi Systems",
      status: "active",
      lifetime_value: 78000,
    },
    {
      name: "Saudi Horizons",
      email: "info@saudi-horizons.com",
      company: "Saudi Horizons",
      status: "vip",
      lifetime_value: 200000,
    },
    {
      name: "Qatar Digital Hub",
      email: "hello@qatar-digital.qa",
      company: "Qatar Digital Hub",
      status: "active",
      lifetime_value: 55000,
    },
    {
      name: "Oman Tech Ventures",
      email: "info@oman-tech.om",
      company: "Oman Tech Ventures",
      status: "at_risk",
      lifetime_value: 22000,
    },
    {
      name: "Kuwait Business Solutions",
      email: "contact@kuwait-biz.kw",
      company: "Kuwait Business Solutions",
      status: "active",
      lifetime_value: 43000,
    },
  ...
  const { data: custRows, error: custErr } = await supabase
    ...
    .select();
  if (custErr) {
    console.error("    Failed:", custErr.message);
    process.exit(1);
  }
  ...
  const { data: leadRows, error: leadErr } = await supabase
    ...
    .select();
  if (leadErr) {
    console.error("    Failed:", leadErr.message);
    process.exit(1);
  }
  ...
  const deals = [
    {
      name: "Dubai Tech Platform Upgrade",
      value: 75000,
      stage: "negotiation",
      probability: 60,
    ...
    {
      name: "Abu Dhabi Systems Integration",
      value: 120000,
      stage: "prospecting",
      probability: 25,
    ...
    {
      name: "Qatar Digital Analytics Platform",
      value: 45000,
      stage: "proposal",
      probability: 40,
    ...
    {
      name: "Kuwait Business ERP Migration",
      value: 85000,
      stage: "closed_won",
      probability: 100,
    ...
    {
      name: "Regional Data Center Setup",
      value: 35000,
      stage: "closed_lost",
      probability: 0,
  ...
  const { data: dealRows, error: dealErr } = await supabase
    ...
    .select();
  if (dealErr) {
    console.error("    Failed:", dealErr.message);
    process.exit(1);
  }
  ...
  const activities = [
    {
      type: "call",
      subject: "Follow-up with Dubai Tech",
      description: "Discussed timeline for platform upgrade",
      related_to: "deal",
      related_id: dealRows[0].id,
    },
    {
      type: "email",
      subject: "Proposal sent to Qatar Digital",
      description: "Sent analytics platform proposal",
      related_to: "deal",
      related_id: dealRows[3].id,
    },
    {
      type: "meeting",
      subject: "Kuwait kickoff meeting",
      description: "Project kickoff meeting completed successfully",
      related_to: "deal",
      related_id: dealRows[5].id,
    },
    {
      type: "demo",
      subject: "Product demo for Abu Dhabi Systems",
      description: "Demonstrated integration capabilities",
      related_to: "deal",
      related_id: dealRows[1].id,
    },
    {
      type: "task",
      subject: "Review Oman Tech contract",
      description: "Need to review security audit terms",
      related_to: "deal",
      related_id: dealRows[4].id,
    },
    {
      type: "call",
      subject: "Discovery call with Saudi Horizons",
      description: "Explored AI suite requirements",
      related_to: "deal",
      related_id: dealRows[2].id,
    },
    {
      type: "email",
      subject: "Follow-up email to Omar Al-Rashid",
      description: "Sent product brochure",
      related_to: "lead",
      related_id: leadRows[0].id,
    },
    {
      type: "meeting",
      subject: "Quarterly review with Acme Corp",
      description: "Reviewed Q2 performance metrics",
      related_to: "customer",
      related_id: custRows[0].id,
    },
    {
      type: "call",
      subject: "Check-in with Layla Hassan",
      description: "Answered questions about pricing",
      related_to: "lead",
      related_id: leadRows[1].id,
    },
    {
      type: "demo",
      subject: "Live demo for Khalid Al-Mansouri",
      description: "Showed advanced reporting features",
      related_to: "lead",
      related_id: leadRows[2].id,
    },
    {
      type: "email",
      subject: "Contract renewal for Kuwait Business",
      description: "Sent renewal terms for FY2027",
      related_to: "customer",
      related_id: custRows[6].id,
    },
    {
      type: "meeting",
      subject: "Strategic planning with Saudi Horizons",
      description: "Discussed Q3-Q4 roadmap alignment",
      related_to: "customer",
      related_id: custRows[3].id,
    },
  ...
  const { data: actRows, error: actErr } = await supabase
    ...
    .select();
  if (actErr) {
    console.error("    Failed:", actErr.message);
    process.exit(1);
  }
  ...
  const invoices = [
    ...
    },
    {
      ...
      customer_name: "Abu Dhabi Systems",
      amount: 22500,
      status: "paid",
      due_date: "2026-06-30",
    ...
    },
    {
      ...
      customer_name: "Qatar Digital Hub",
      amount: 8750,
      status: "draft",
      due_date: "2026-08-01",
    ...
    },
    {
      ...
      customer_name: "Kuwait Business Solutions",
      amount: 32000,
      status: "overdue",
      due_date: "2026-05-01",
    ...
    },
    {
      ...
      customer_name: "Oman Tech Ventures",
      amount: 5000,
      status: "paid",
      due_date: "2026-06-01",
  ...
  const { data: invRows, error: invErr } = await supabase
    ...
    .select();
  if (invErr) {
    console.error("    Failed:", invErr.message);
    process.exit(1);
  }
  ...
  const { data: budRows, error: budErr } = await supabase
    ...
    .select();
  if (budErr) {
    console.error("    Failed:", budErr.message);
    process.exit(1);
  }
  ...
  const transactions = [
    {
      ...
      amount: 150000,
      description: "Q2 platform license revenue",
    ...
    },
    {
      ...
      category: "Consulting",
      amount: 85000,
      description: "Integration consulting fees",
    ...
    },
    {
      ...
      category: "Product Sales",
      amount: 165000,
      description: "May license renewals",
    ...
    },
    {
      ...
      category: "Consulting",
      amount: 92000,
      description: "Abu Dhabi Systems consulting",
    ...
    },
    {
      ...
      category: "Office",
      amount: 12000,
      description: "Utilities & supplies",
    ...
    },
    {
      ...
      category: "Product Sales",
      amount: 180000,
      description: "June enterprise deals",
    ...
    },
    {
      ...
      category: "Training",
      amount: 22000,
      description: "Corporate training sessions",
  ...
  const { data: txRows, error: txErr } = await supabase
    ...
    .select();
  if (txErr) {
    console.error("    Failed:", txErr.message);
    process.exit(1);
  }
  ...
  const { data: deptRows, error: deptErr } = await supabase
    ...
    .select();
  if (deptErr) {
    console.error("    Failed:", deptErr.message);
    process.exit(1);
  }
  ...
  const { data: empRows, error: empErr } = await supabase
    ...
    .select();
  if (empErr) {
    console.error("    Failed:", empErr.message);
    process.exit(1);
  }
  ...
  if (engDept && vpEng) {
    ...
    await supabase
      .from("hr_employees")
      .update({ department_id: engDept.id })
      .eq("id", empRows.find((e) => e.position === "Senior Developer").id);
  }
  if (salesDept && salesDir) {
    await supabase.from("hr_departments").update({ head_id: salesDir.id }).eq("id", salesDept.id);
    await supabase
      .from("hr_employees")
      .update({ department_id: salesDept.id })
      .eq("id", salesDir.id);
  }
  if (mktgDept && mktgDir) {
  ...
  const { data: payRows, error: payErr } = await supabase
    ...
    .select();
  if (payErr) {
    console.error("    Failed:", payErr.message);
    process.exit(1);
  }
  ...
  const { data: spRows, error: spErr } = await supabase
    ...
    .select();
  if (spErr) {
    console.error("    Failed:", spErr.message);
    process.exit(1);
  }
  ...
  const orders = [
    ...
    },
    {
      ...
      customer_id: custRows[6].id,
      total: 65000,
      status: "shipped",
      order_date: "2026-06-20",
    },
    {
      order_number: "SO-2026-008",
      customer_id: custRows[0].id,
      total: 15000,
      status: "pending",
  ...
  const { data: ordRows, error: ordErr } = await supabase
    ...
    .select();
  if (ordErr) {
    console.error("    Failed:", ordErr.message);
    process.exit(1);
  }
  ...
  const projects = [
    {
      ...
      description: "Complete redesign of core platform UI/UX",
      status: "active",
      priority: "high",
    ...
    {
      name: "Mobile App v2",
      description: "Native mobile app rewrite",
      status: "on_hold",
      priority: "high",
    ...
    {
      name: "Data Migration",
      description: "Migrate legacy data to new warehouse",
      status: "active",
      priority: "medium",
    ...
    },
    {
      ...
      description: "GDPR and data residency compliance updates",
      status: "active",
      priority: "high",
  ...
  const { data: projRows, error: projErr } = await supabase
    ...
    .select();
  if (projErr) {
    console.error("    Failed:", projErr.message);
    process.exit(1);
  }
  ...
  const taskData = [
    ...
    {
      project_name: "Compliance Upgrade",
  ...
  const { data: whRows, error: whErr } = await supabase
    ...
    .select();
  if (whErr) {
    console.error("    Failed:", whErr.message);
    process.exit(1);
  }
  ...
  const suppliers = [
    {
      name: "TechSupply Middle East",
      contact_name: "Khalid Al-Rashid",
      email: "khalid@techsupply.ae",
      phone: "+971-50-123-4567",
    },
    {
      name: "Global Parts Trading",
      contact_name: "Ahmed Hassan",
      email: "ahmed@globalparts.ae",
      phone: "+971-55-987-6543",
    },
    {
      name: "Quality Components LLC",
      contact_name: "Mohammed Noor",
      email: "mohammed@qualitycomp.com",
      phone: "+966-55-111-2222",
    },
    {
      name: "Gulf Logistics Solutions",
      contact_name: "Saeed Al-Otaibi",
      email: "saeed@gulflogistics.com",
      phone: "+965-99-333-4444",
    },
  ...
  const { data: suppRows, error: suppErr } = await supabase
    ...
    .select();
  if (suppErr) {
    console.error("    Failed:", suppErr.message);
    process.exit(1);
  }
  ...
  const invProducts = [
    {
      ...
      quantity: 45,
      reorder_level: 10,
      warehouse_id: whRows[0].id,
      supplier_id: suppRows[0].id,
    },
    {
      name: "Wireless Mouse",
      sku: "MOU-001",
    ...
    },
    {
      ...
      quantity: 150,
      reorder_level: 30,
      warehouse_id: whRows[1].id,
      supplier_id: suppRows[2].id,
    },
    {
      name: '4K Monitor 27"',
      sku: "MON-001",
    ...
    },
    {
      ...
      quantity: 5,
      reorder_level: 2,
      warehouse_id: whRows[2].id,
      supplier_id: suppRows[3].id,
    },
    {
  ...
  const { data: invProdRows, error: invProdErr } = await supabase
    .from("inventory_products")
    .insert(invProducts)
    .select();
  if (invProdErr) {
    console.error("    Failed:", invProdErr.message);
    process.exit(1);
  }
  ...
  const { data: docRows, error: docErr } = await supabase
    ...
    .select();
  if (docErr) {
    console.error("    Failed:", docErr.message);
    process.exit(1);
  }
  ...
  const notifications = [
    {
      ...
      message: "Invoice INV-2026-005 from Kuwait Business Solutions is overdue",
      type: "warning",
    },
    {
      title: "New Deal Closed",
      message: "Kuwait Business ERP Migration deal worth $85,000 has been closed won",
      type: "success",
    },
    {
      title: "Low Stock Alert",
      message: "Mechanical Keyboard is below reorder level (8 remaining)",
      type: "error",
    },
    { title: "Project Update", message: "Platform Redesign is 65% complete", type: "info" },
    {
      title: "Payroll Processed",
      message: "June payroll has been processed successfully",
      type: "success",
    },
    {
      title: "New Lead Assigned",
      message: "Faisal Al-Qahtani has been assigned as a qualified lead",
      type: "info",
    },
    {
      title: "Budget Alert",
      message: "Engineering department has used 64% of Q2 budget",
      type: "warning",
    },
  ...
  const { data: notifRows, error: notifErr } = await supabase
    ...
    .select();
  if (notifErr) {
    console.error("    Failed:", notifErr.message);
    process.exit(1);
  }
  ...
  const dashboards = [
    {
      ...
      description: "High-level KPI dashboard for leadership",
      config: { widgets: ["revenue", "customers", "deals", "employees"] },
    },
    {
      name: "Sales Pipeline",
      description: "Sales team pipeline and forecasting",
      config: { widgets: ["deals_by_stage", "monthly_revenue", "conversion_rate"] },
    },
    {
      name: "Engineering Velocity",
      description: "Engineering metrics and project tracking",
      config: { widgets: ["sprint_burndown", "task_completion", "deployment_frequency"] },
    },
  ].map((d) => ({ ...d, organization_id: orgId }));
  const { data: dashRows, error: dashErr } = await supabase
    ...
    .select();
  if (dashErr) {
    console.error("    Failed:", dashErr.message);
    process.exit(1);
  }
  ...
  const { data: dsRows, error: dsErr } = await supabase
    ...
    .select();
  if (dsErr) {
    console.error("    Failed:", dsErr.message);
    process.exit(1);
  }
  ...
  const datasets = [
    {
      ...
      original_filename: "Q2_Sales_Data.xlsx",
      columns: [
        { name: "date", type: "date" },
        { name: "revenue", type: "number" },
        { name: "region", type: "string" },
      ],
      rows: [{ date: "2026-04-01", revenue: 150000, region: "UAE" }],
      row_count: 1,
      status: "draft",
    },
    {
      name: "Employee Directory.csv",
      original_filename: "employee_directory.csv",
      columns: [
        { name: "name", type: "string" },
        { name: "department", type: "string" },
        { name: "email", type: "string" },
      ],
      rows: [{ name: "Ahmed Al-Maktoum", department: "Executive", email: "ahmed@acme-corp.com" }],
      row_count: 1,
      status: "draft",
    },
    {
      name: "Inventory Count.xlsx",
      original_filename: "inventory_count.xlsx",
      columns: [
        { name: "sku", type: "string" },
        { name: "quantity", type: "number" },
        { name: "warehouse", type: "string" },
      ],
      rows: [{ sku: "LAP-001", quantity: 45, warehouse: "Dubai Main" }],
      row_count: 1,
      status: "draft",
    },
  ].map((d) => ({ ...d, organization_id: orgId }));
  const { data: dsets, error: dsetErr } = await supabase
    .from("imported_datasets")
    .insert(datasets)
    .select();
  if (dsetErr) {
    console.error("    Failed:", dsetErr.message);
    process.exit(1);
  }
  ...
  const mappings = [
    {
      ...
      target_table: "finance_transactions",
      column_mapping: { date: "transaction_date", revenue: "amount", region: "description" },
      transform_rules: {},
    },
    {
      name: "Employee Mapping",
      dataset_id: dsets[1].id,
      source_columns: [
        { name: "name", type: "string" },
        { name: "department", type: "string" },
        { name: "email", type: "string" },
      ...
      column_mapping: { name: "full_name", department: "department", email: "email" },
      transform_rules: {},
    },
    {
      name: "Inventory Mapping",
      dataset_id: dsets[2].id,
      source_columns: [
        { name: "sku", type: "string" },
        { name: "quantity", type: "number" },
        { name: "warehouse", type: "string" },
      ...
      column_mapping: { sku: "sku", quantity: "quantity", warehouse: "warehouse" },
      transform_rules: {},
    },
  ...
  const { data: mapRows, error: mapErr } = await supabase
    ...
    .select();
  if (mapErr) {
    console.error("    Failed:", mapErr.message);
    process.exit(1);
  }
