      ...
      <main className="pt-32 pb-section-padding px-gutter max-w-container-max mx-auto min-h-screen">
        ...
        <header className="mb-stack-lg">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
            <div>
              <span className="font-label-mono text-label-mono text-primary uppercase mb-2 block tracking-widest">
                Global Analytics Console
              </span>
              <h1 className="font-display-lg text-display-lg-mobile md:text-headline-md text-on-surface">
                Intelligence Overview
              </h1>
            </div>
            <div className="flex items-center gap-2 bg-eye-surface border border-eye-border p-1 rounded">
              <button className="px-4 py-1.5 font-label-mono text-[10px] bg-surface-container-highest text-on-surface rounded">
                24H
              </button>
              <button className="px-4 py-1.5 font-label-mono text-[10px] text-eye-text hover:text-on-surface">
                7D
              </button>
              <button className="px-4 py-1.5 font-label-mono text-[10px] text-eye-text hover:text-on-surface">
                30D
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[280px]">
          ...
          <div className="bento-card md:col-span-1 md:row-span-2 p-8 flex flex-col justify-between">
            <div>
              <div className="flex justify-between items-start mb-6">
                <span className="font-label-mono text-label-mono text-eye-text uppercase">
                  Projected OpEx
                </span>
                <span className="material-symbols-outlined text-primary">payments</span>
              </div>
              <div className="space-y-1">
                <span className="font-display-lg text-display-lg-mobile text-on-surface block">
                  $14,204
                </span>
            ...
            <div className="mt-auto pt-6 border-t border-eye-border">
              <p className="font-body-sm text-body-sm text-eye-text leading-relaxed">
                Operational efficiency is trending within the 95th percentile. Optimized routing
                enabled.
              </p>
            </div>
          </div>
          ...
          <div className="bento-card md:col-span-2 p-6 flex flex-col">
            <div className="flex justify-between items-center mb-8">
              <div>
                <h2 className="font-label-mono text-label-mono text-on-surface uppercase">
                  Token Consumption
                </h2>
                <p className="text-[10px] text-eye-text font-label-mono mt-1">
                  Distributed across 12 node clusters
                </p>
              </div>
            ...
            <div className="flex-grow flex items-end justify-between gap-2 px-2">
              <div className="flex flex-col items-center gap-3 w-full">
                <div
                  className="bg-primary/20 hover:bg-primary/40 border-t border-primary/40 w-full rounded-t-sm bar-chart-rect"
              ...
              <div className="flex flex-col items-center gap-3 w-full">
                <div
                  className="bg-primary w-full rounded-t-sm bar-chart-rect"
          ...
          <div className="bento-card md:col-span-2 p-6 flex flex-col overflow-visible">
            <div className="flex justify-between items-center mb-4">
              <div>
                ...
                <div className="flex items-center gap-4 mt-1">
                  <div className="flex items-center gap-1.5">
                    ...
                    <span className="text-[10px] text-eye-text font-label-mono">
                      Inference (ms)
                    </span>
                  </div>
                  <div className="flex items-center gap-1.5">
              ...
              <div className="text-right">
                <span className="font-label-mono text-headline-md text-on-surface">
                  42<span className="text-body-sm font-body-sm text-eye-text ml-1">ms</span>
                </span>
            ...
            <div className="flex-grow relative mt-4">
              ...
              >
                <path
                  d="M0,80 Q50,75 100,50 T200,60 T300,20 T400,30"
                  fill="none"
                  stroke="#1A1A1C"
                  stroke-width="2"
                ></path>
                <path
                  ...
                  d="M0,90 Q50,85 100,60 T200,70 T300,30 T400,40"
                  fill="none"
                  stroke="#90d7ff"
                  stroke-width="2.5"
                ></path>
          ...
          <div className="bento-card p-12 overflow-hidden min-h-[400px] flex items-center justify-center relative">
            <div className="absolute inset-0 opacity-20">
              <div
                ...
                data-alt="Ultra-modern server farm interior at night with neon blue fiber optic cables flowing between sleek black server racks. Scientific researchers in minimalist white lab coats are monitoring holographic data displays. The lighting is low and atmospheric with sharp cinematic contrasts."
                style={{
                  backgroundImage:
                    "url('https://lh3.googleusercontent.com/aida-public/AB6AXuC3jfpdDCCN0akq4SZcVLwizdNJ8sBxGCvYPRctwah7i1xMcsnK5JDE35MKNRGqX9lIW5i2FcPrOxUUWPWvqo0MUMQmP6NU1v-acGbER5aWX_utGp5J_R7AwypEKDcSQF2kDmZ_AvlFOfhf9OxJ4xG2KFYt5Sx1zPv5FkO2_0K0fot_Izn77pvz1Ye-nGg3iRmfCaK0yN2soFGC7vRdvBgc9UoaIxoqfE3ofvbo2FTLzOSRg04OuNQF-bCWSVJ0qbKEWxbVP5bSlPs')",
                }}
              ></div>
            </div>
            <div className="relative z-10 text-center max-w-2xl">
              ...
              <h2 className="font-headline-md text-on-surface mb-6">
                Omni-Channel Intelligence Network
              </h2>
              <p className="font-body-lg text-body-lg text-eye-text mb-8">
                Our distributed infrastructure utilizes shard-based processing to deliver
                sub-millisecond response times across all global regions.
              </p>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                <div>
                  <p className="font-label-mono text-headline-md text-on-surface">
                    99.99<span className="text-body-sm">%</span>
                  </p>
                  <p className="font-label-mono text-[10px] text-eye-text">UPTIME</p>
                </div>
                <div>
                  <p className="font-label-mono text-headline-md text-on-surface">
                    1.2<span className="text-body-sm">PB</span>
                  </p>
                ...
                <div>
                  <p className="font-label-mono text-headline-md text-on-surface">
                    4.2<span className="text-body-sm">k</span>
                  </p>
