      ...
      <main className="pt-24 pb-section-padding max-w-container-max mx-auto px-gutter min-h-screen">
        ...
        <div className="mb-stack-lg flex flex-col md:flex-row md:items-end justify-between gap-stack-md">
          <div>
            <div className="flex items-center gap-2 mb-2">
              <span className="font-label-mono text-primary text-[10px] tracking-[0.2em] uppercase">
                Intelligence Core
              </span>
              <div className="w-1.5 h-1.5 rounded-full bg-primary animate-pulse"></div>
            </div>
            <h1 className="font-display-lg text-display-lg-mobile text-on-surface mb-2">
              RAG Knowledge Bases
            </h1>
            <p className="font-body-sm text-eye-text max-w-xl">
              Manage high-density neural context repositories for federated enterprise intelligence.
              Ensure data consistency and vector optimization across your distributed management
              cluster.
            </p>
          </div>
          <div className="flex items-center gap-3">
            <div className="flex items-center bg-eye-surface border border-eye-border rounded-sm px-3 py-2 w-64 group focus-within:border-primary/50 transition-all">
              <span className="material-symbols-outlined text-eye-text group-focus-within:text-primary transition-colors mr-2">
                search
              </span>
              <input
                className="bg-transparent border-none p-0 focus:ring-0 text-body-sm w-full placeholder:text-eye-text/50"
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-stack-md">
          <div className="bg-eye-surface border border-eye-border p-4 rounded-sm">
            <span className="font-label-mono text-eye-text text-[10px] block mb-1">
              TOTAL DOCUMENTS
            </span>
        ...
        <div className="bg-eye-surface border border-eye-border rounded-sm overflow-hidden mb-section-padding">
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse">
              <thead className="bg-[#0D0D0F] border-b border-eye-border">
                <tr>
                  <th className="px-4 py-3 font-label-mono text-[11px] text-eye-text uppercase tracking-widest">
                    Name
                  </th>
                  <th className="px-4 py-3 font-label-mono text-[11px] text-eye-text uppercase tracking-widest">
                    Type
                  ...
                  <th className="px-4 py-3 font-label-mono text-[11px] text-eye-text uppercase tracking-widest text-right">
                    Actions
                  </th>
                </tr>
              </thead>
              <tbody className="divide-y divide-[#1A1A1C]">
                ...
                <tr className="data-table-row transition-colors group">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="text-on-surface font-medium">
                          Enterprise_Strategy_2025.pdf
                        </div>
                        <div className="text-[10px] text-eye-text font-label-mono">
                          Last modified: 2h ago
                        </div>
                      </div>
                    </div>
                  </td>
                  <td className="px-4 py-2 font-label-mono text-[11px] text-eye-text">
                    PDF / Application
                  </td>
                  ...
                  <td className="px-4 py-2 text-right">
                    <button className="material-symbols-outlined text-eye-text hover:text-on-surface transition-colors">
                      more_vert
                    </button>
                  </td>
                </tr>
                ...
                <tr className="data-table-row transition-colors group">
                  <td className="px-4 py-2">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="text-on-surface font-medium">
                          Customer_Feedback_Cluster_A.json
                        </div>
                        <div className="text-[10px] text-eye-text font-label-mono">
                  ...
                  <td className="px-4 py-2 font-label-mono text-[11px] text-eye-text italic">
                    Calculating...
                  </td>
                  <td className="px-4 py-2 text-right">
                    <button className="material-symbols-outlined text-eye-text hover:text-on-surface transition-colors">
                ...
                <tr className="data-table-row transition-colors group">
                  <td className="px-4 py-2">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="text-on-surface font-medium">
                          Internal_Network_Log_Dec.log
                        </div>
                        <div className="text-[10px] text-error font-label-mono">
          ...
          <div className="bg-[#0D0D0F] border-t border-eye-border px-4 py-3 flex items-center justify-between">
            <span className="text-eye-text font-label-mono text-[10px]">
              SHOWING 1-6 OF 1,402 DOCUMENTS
            </span>
            <div className="flex items-center gap-2">
              ...
              <button className="w-8 h-8 flex items-center justify-center bg-primary/10 border border-primary/30 rounded-sm text-primary font-label-mono text-[10px]">
                1
              </button>
              <button className="w-8 h-8 flex items-center justify-center border border-eye-border rounded-sm hover:bg-eye-border/10 text-eye-text font-label-mono text-[10px]">
                2
              </button>
              <button className="w-8 h-8 flex items-center justify-center border border-eye-border rounded-sm hover:bg-eye-border/10 text-eye-text font-label-mono text-[10px]">
                3
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-eye-surface border border-eye-border rounded-sm p-6 relative overflow-hidden group">
            ...
            <h3 className="font-headline-md text-[18px] text-on-surface mb-3">
              Security Protocols
            </h3>
            <p className="text-eye-text text-body-sm mb-4">
              Documents are encrypted with AES-256 and stored in a multi-tenant isolated
              architecture.
            </p>
          ...
          <div className="bg-eye-surface border border-eye-border rounded-sm p-6 relative overflow-hidden group">
            ...
            <p className="text-eye-text text-body-sm mb-4">
              Auto-semantic grouping of related documents to minimize RAG hallucination and improve
              recall.
            </p>
            <button className="text-primary font-label-mono text-[11px] flex items-center gap-2 hover:gap-3 transition-all">
          ...
          <div className="bg-eye-surface border border-eye-border rounded-sm p-6 relative overflow-hidden group">
            ...
            <p className="text-eye-text text-body-sm mb-4">
              Programmatically ingest and query your knowledge base using our high-throughput REST
              API.
            </p>
            <button className="text-primary font-label-mono text-[11px] flex items-center gap-2 hover:gap-3 transition-all">
