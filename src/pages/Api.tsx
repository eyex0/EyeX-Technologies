      ...
      <header className="fixed top-0 w-full h-16 bg-[#050505]/60 backdrop-blur-xl border-b border-eye-border z-50">
        <div className="flex justify-between items-center px-gutter max-w-container-max mx-auto h-full">
          <div className="flex items-center gap-8">
            <span className="font-display-lg text-display-lg-mobile md:text-headline-md tracking-tighter text-on-surface">
              EyeX
            </span>
            <nav className="hidden md:flex gap-6 items-center">
              <a
                className="text-eye-text hover:text-on-surface transition-colors duration-300"
                href="#"
              >
                Network
              </a>
              ...
              <a className="text-on-surface font-medium" href="#">
                Intelligence
              </a>
              <a
                className="text-eye-text hover:text-on-surface transition-colors duration-300"
        ...
        <div className="mb-stack-lg">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
            <div>
              ...
              <p className="text-eye-text max-w-2xl">
                Manage your computational endpoints, monitor live traffic, and secure your enclave
                with enterprise-grade key management.
              </p>
            </div>
            <div className="flex items-center gap-3">
              <div className="flex bg-eye-surface border border-eye-border rounded-lg p-1">
                <button className="px-4 py-1.5 rounded text-on-surface bg-surface-container-highest transition-all font-medium text-xs">
                  Production
                </button>
                <button className="px-4 py-1.5 rounded text-eye-text hover:text-on-surface transition-all text-xs">
                  Staging
                </button>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-stack-md">
          ...
          <div className="lg:col-span-3 flex flex-col gap-stack-md">
            ...
            <div className="bg-eye-surface border border-eye-border rounded-xl p-5 overflow-hidden relative group">
              ...
              <span className="font-label-mono text-[10px] text-eye-text uppercase mb-4 block">
                System Status
              </span>
          ...
          <div className="lg:col-span-9 flex flex-col gap-stack-md">
            ...
            <div className="bg-eye-surface border border-eye-border rounded-xl overflow-hidden">
              <div className="p-6 border-b border-eye-border flex justify-between items-center">
                <div>
                  ...
                  <p className="text-xs text-eye-text mt-1">
                    Manage secret keys for authenticating with the EyeX API.
                  </p>
                </div>
                ...
                <div className="p-6 flex flex-col md:flex-row md:items-center justify-between gap-4 group">
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <span className="text-[10px] px-1.5 py-0.5 rounded border border-eye-border text-eye-text font-label-mono">
                        READ/WRITE
                      </span>
                    </div>
                    <div className="flex items-center gap-3 font-label-mono text-sm text-eye-text">
                      <code
                        className="bg-[#050505] px-2 py-1 rounded border border-eye-border tracking-wider"
                        id="key-1"
                      >
                        sk_live_••••••••••••••••••••3a7b
                      </code>
            ...
            <div className="bg-[#050505] border border-eye-border rounded-xl overflow-hidden shadow-2xl">
              <div className="bg-eye-surface px-4 py-3 border-b border-eye-border flex items-center justify-between">
                ...
                <div className="flex items-center gap-4">
                  <span className="font-label-mono text-[11px] text-eye-text">
                    1.2ms Avg Latency
                  </span>
                  <button
                    aria-label="Filter traffic logs"
                    className="text-eye-text hover:text-on-surface transition-colors"
                  >
              ...
              <div
                className="p-4 h-[400px] font-label-mono text-[13px] leading-relaxed console-scrollbar overflow-y-auto overflow-x-hidden space-y-1.5"
              ...
              >
                <div className="flex gap-4 group">
                  ...
                  <span className="ml-auto text-eye-text opacity-0 group-hover:opacity-100 transition-opacity">
                    id: tr_9281a
                  </span>
                </div>
                <div className="flex gap-4 group">
                ...
                <div className="flex gap-4 group">
                  ...
                  <span className="ml-auto text-eye-text opacity-0 group-hover:opacity-100 transition-opacity italic">
                    invalid_token
                  </span>
                </div>
                <div className="flex gap-4 group">
                ...
                <div className="flex gap-4 group bg-red-500/5 -mx-4 px-4 py-0.5 border-y border-red-500/10">
                  ...
                  <span className="ml-auto text-red-400 opacity-80 transition-opacity">
                    upstream_timeout
                  </span>
                </div>
                <div className="flex gap-4 group">
              ...
              <div className="bg-eye-surface border-t border-eye-border p-3 flex items-center gap-3">
                ...
                <input
                  className="bg-transparent border-none focus:ring-0 text-xs w-full text-on-surface placeholder:text-eye-text/50 font-label-mono"
