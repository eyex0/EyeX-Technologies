          ...
          render: () => (
            <TableCard
              ...
              columns={[
                ...
                { key: "industry", label: "Industry" },
                { key: "contact", label: "Primary" },
                { key: "value", label: "ACV", align: "right" },
              ]}
              rows={m.customers}
            />
          ),
          ...
          render: () => (
            <Card title="Recent activities" icon="history">
              <div className="p-5 space-y-3">
                {[
                  "Call with Sarah Chen (Acme)",
                  "Sent proposal to Adventure Works",
                  "Demo scheduled — Contoso",
                  "Email opened by Wayne Enterprises",
                  "Meeting notes: Globex QBR",
                ].map((a, i) => (
                  <div
                    key={a}
