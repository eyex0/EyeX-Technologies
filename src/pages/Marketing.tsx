    ...
    <ModulePage
      ...
      tabs={[
            ...
            <>
              <div className="mb-4 p-4 bg-sky-500/10 border border-sky-500/20 rounded flex items-center gap-3">
                ...
                <span className="text-sm text-sky-200">
                  Connect your marketing data source to see real analytics.
                </span>
                <Link
                  to="/data-sources"
                  className="ml-auto text-[10px] font-bold uppercase tracking-widest bg-white text-black px-3 py-1.5 rounded hover:bg-white/90 transition"
                >
                  Go to Data Sources
                </Link>
              </div>
              ...
              {[
                ...
                <div key={c} className="bento-card rounded-lg p-5">
                  ...
                  <div className="text-xs text-muted-foreground mt-1">
                    ROAS <span className="text-muted-foreground font-mono">{r}</span>
                  </div>
                </div>
              ))}
            </div>
        ...
        },
        {
          ...
          label: "Performance",
          render: () => (
            <Card title="Performance — 12w">
              <BarChart
                data={Array.from({ length: 12 }, (_, i) => ({ label: `W${i + 1}`, value: 0 }))}
              />
            </Card>
          ),
        },
