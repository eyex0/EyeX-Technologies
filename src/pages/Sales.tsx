  ...
  return <ModulePage title="Sales" subtitle="Orders · Revenue · Forecast" tabs={[
    { key: "dash", label: "Dashboard", render: () => (
      <>
        ...
        <Card title="Revenue by week"><BarChart data={Array.from({length:12},(_,i)=>({label:`W${i+1}`,value:30+i*5+Math.random()*10}))}/></Card>
      </>
    )},
    ...
    { key: "revenue", label: "Revenue", render: () => (
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card title="Revenue mix"><BarChart data={[{label:"Sub",value:82},{label:"Pro",value:56},{label:"Ent",value:120},{label:"Serv",value:38}]}/></Card>
