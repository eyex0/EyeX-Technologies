...
<span className="material-symbols-outlined text-eye-bg" style={{fontVariationSettings: "'wght' 700"}}>all_inclusive</span>
</div>
<span className="font-display-lg text-[18px] tracking-tight text-on-surface font-bold">EyeX</span>
</div>
<button aria-label="New chat" className="text-eye-text hover:text-on-surface transition-colors cursor-pointer active:scale-95">
<span className="material-symbols-outlined">edit_square</span>
</button>
</div>
<div className="px-4 py-2">
<div className="relative group">
<span className="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-eye-text text-sm">search</span>
<input className="w-full bg-eye-bg border-eye-border focus:border-primary/50 rounded-lg text-xs py-2 pl-9 pr-4 font-label-mono focus:ring-0 outline-none transition-all" placeholder="Search Intel..." type="text" />
</div>
</div>
<nav className="flex-1 overflow-y-auto px-4 py-6 custom-scrollbar space-y-6">
<div className="space-y-1">
<div className="text-[10px] uppercase tracking-widest text-eye-text/50 font-label-mono px-3 mb-2">Today</div>
<a className="flex items-center gap-3 px-3 py-2 rounded-lg bg-surface-container text-on-surface font-medium transition-all group" href="#">
<span className="material-symbols-outlined text-primary text-[18px]">terminal</span>
<span className="truncate">Network Latency Audit</span>
</a>
<a className="flex items-center gap-3 px-3 py-2 rounded-lg text-eye-text hover:bg-eye-border/30 hover:text-on-surface transition-all group" href="#">
<span className="material-symbols-outlined text-[18px]">security</span>
<span className="truncate">Threat Vector Analysis</span>
</a>
</div>
<div className="space-y-1">
<div className="text-[10px] uppercase tracking-widest text-eye-text/50 font-label-mono px-3 mb-2">Yesterday</div>
<a className="flex items-center gap-3 px-3 py-2 rounded-lg text-eye-text hover:bg-eye-border/30 hover:text-on-surface transition-all group" href="#">
...
<h1 className="font-headline-md text-[18px] text-on-surface font-bold tracking-tight">Intelligence Core v4.2</h1>
<div className="px-2 py-0.5 rounded bg-primary/10 border border-primary/20 text-[10px] text-primary font-label-mono">SECURE</div>
</div>
...
<span className="material-symbols-outlined text-on-surface text-[22px]">person_check</span>
</div>
<div className="flex-1 pt-2">
<div className="font-label-mono text-[10px] text-eye-text uppercase tracking-widest mb-2">Request - 14:22:01</div>
<div className="font-body-sm text-on-surface text-[15px] leading-relaxed">
              Analyze current latency spikes in the Frankfurt region cluster. Provide a surgical breakdown of the bottleneck and suggest primary remediation paths for immediate deployment.
            </div>
</div>
</div>
...
<span className="material-symbols-outlined text-primary text-[22px] relative z-10" style={{fontVariationSettings: "'wght' 500"}}>all_inclusive</span>
</div>
<div className="flex-1 pt-2 space-y-6">
<div className="font-label-mono text-[10px] text-primary uppercase tracking-widest mb-2">Synthesizing intelligence...</div>
<div className="space-y-4">
{/* Thinking Glass Card */}
<div className="glass-effect bento-border rounded-xl p-6 space-y-4">
<div className="flex items-center gap-3">
<div className="w-2 h-2 rounded-full bg-primary animate-pulse"></div>
<span className="text-sm font-medium text-on-surface">Bottleneck Identified: Port 8080 congestion</span>
</div>
...
<span className="text-primary">$</span> eye-trace --target fra-cluster-04<br />
<span className="text-eye-text/60">Tracing route to fra-cluster-04.eyex.internal...</span><br />
<span className="text-on-surface">[CRITICAL] 482ms delay detected at edge-gateway-02</span>
</div>
</div>
{/* Main Response Body */}
<div className="font-body-sm text-on-surface text-[15px] leading-relaxed">
                The spikes originate from a misconfigured load balancer at the Frankfurt edge. Direct analysis reveals a <span className="text-primary font-medium">342% increase</span> in unhandled TCP handshakes during the 14:00 window.
              </div>
{/* Bento Grid for stats/results */}
<div className="grid grid-cols-2 gap-4">
<div className="bento-border rounded-xl p-4 bg-eye-surface/50">
<div className="text-[10px] font-label-mono text-eye-text uppercase mb-1">Peak Latency</div>
<div className="text-2xl font-bold text-on-surface tracking-tighter">894ms</div>
</div>
<div className="bento-border rounded-xl p-4 bg-eye-surface/50">
<div className="text-[10px] font-label-mono text-eye-text uppercase mb-1">Affected Nodes</div>
<div className="text-2xl font-bold text-on-surface tracking-tighter">14 Nodes</div>
</div>
</div>
</div>
</div>
...
<span className="text-sm font-medium text-primary">System recommends immediate patch deployment to Frankfurt Gateways.</span>
</div>
