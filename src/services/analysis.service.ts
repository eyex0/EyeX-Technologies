              ...
              widgets: {
                ...
                items: {
                  ...
                  properties: {
                    ...
                    chartType: { type: Type.STRING, description: "For chart type. e.g., line, bar, pie" },
                    data: {
                      type: Type.ARRAY,
                    ...
                    icon: { type: Type.STRING, description: "For kpi type, Material icon name, optional" },
                    tone: { type: Type.STRING, description: "For insight type, e.g., success, warn, info, or danger, optional" },
                  },
                  required: ["type", "title"]
                }
              }
