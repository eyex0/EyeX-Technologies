...
export const integrationsCatalog = [
  {
    name: "Google Sheets",
    desc: "Sync spreadsheets bi-directionally",
    status: "Connected",
    icon: "table_chart",
  },
  {
    name: "Excel",
    desc: "Import & export Excel workbooks",
    status: "Connected",
    icon: "table_view",
  },
  {
    name: "Supabase",
    desc: "Managed Postgres + Auth backend",
    status: "Connected",
    icon: "database",
  },
  {
    name: "Stripe",
    desc: "Payments, subscriptions, invoicing",
    status: "Connected",
    icon: "payments",
  },
  {
    name: "Shopify",
    desc: "Ecommerce orders and products",
    status: "Available",
    icon: "storefront",
  },
  ...
  {
    name: "Notion",
    desc: "Docs and knowledge base sync",
    status: "Available",
    icon: "sticky_note_2",
  },
  {
...
export const notifications = [
  ...
  {
    title: "Deploy succeeded: Vector v2 build 481",
    meta: "Platform • 1h ago",
    tone: "success" as const,
  },
  {
    title: "Stock alert: Inference Cluster (3 left)",
    meta: "Inventory • 2h ago",
